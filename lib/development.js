 ...
 * Stored in Postgres.
 */
async function loadDevelopmentSeries() {
  return loadDevelopmentDoc();
}
...
async function writeDevelopmentSeries(_dataDir, doc) {
  return writeDevelopmentDoc(doc);
}

module.exports = {
  getDevelopmentSeriesStoreTarget: getDevelopmentStoreTarget,
